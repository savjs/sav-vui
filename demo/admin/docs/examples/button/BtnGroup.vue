<template>
  <div>
    ...
    <sav-btn-group :color="color" :size="size">
      <sav-btn  :color="color" :size="size" ><SavIcon icon="fa-github"></SavIcon>按钮</sav-btn>
      <sav-btn  :color="color" :size="size">一般按钮</sav-btn>
      <sav-btn  :color="color" :size="size" >一般按钮</sav-btn>
    </sav-btn-group>
    <sav-btn-group :color="color" :size="size" vertical>
      <sav-btn  :color="color" :size="size"><SavIcon icon="fa-github"></SavIcon>按钮</sav-btn>
      <sav-btn  :color="color" :size="size">一般按钮</sav-btn>
      <sav-btn  :color="color" :size="size">一般按钮</sav-btn>
    </sav-btn-group>
